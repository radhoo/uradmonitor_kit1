...
void enc28j60Init(uint8_t* macaddr) {
	...
	CSPASSIVE; // ss=0
	//
	ENC28J60_CONTROL_DDR |=
			1 << ENC28J60_CONTROL_SI | 1 << ENC28J60_CONTROL_SCK; // mosi, sck output
...
// Contributed by Alex M. Based on code from: http://blog.derouineau.fr/2011/07/putting-enc28j60-ethernet-controler-in-sleep-mode/
void powerDown() {
