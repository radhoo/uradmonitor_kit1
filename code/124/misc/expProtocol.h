...
#define ID_NOISE "11"					// optional: noise in dB
#define ID_PM1_UGCM "12"				// optional: particulate matter in micro grams per cubic meter
#define ID_PM10_UGCM "13"				// optional: particulate matter in micro grams per cubic meter
#define ID_O3_PPB "14"					// optional: ozone in ppb
